            ...
            <table class="table-inner" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td align="center" style="line-height: 0px;">
                        <img style="display:block; line-height:0px; font-size:0px; border:0px; width: 200px;" src="cid:<?php echo $cid_icone; ?>" alt="logo ConnectMangas" />
                    </td>
                </tr>
                <!-- end logo -->
                <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <table align="center" class="table-inner" width="500" border="0" cellspacing="0" cellpadding="0">
                                        <!-- title -->
                                        <tr>
                                            <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:28px; color:#3b3b3b; font-weight: bold; letter-spacing:4px;">Bienvenue sur ConnectMangas !</td>
                                        </tr>
                                        <!-- end title -->
                                        <tr>
                                            <td align="center">
