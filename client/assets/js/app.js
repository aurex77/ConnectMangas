    ...
    app.factory('mangasService', function($http, $cookies, sAlert) {
        ...
        return {
            getMangaById: function(id) {
                ...
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/manga/'+id,
                    headers: {
                        'User-ID': userID
                    }
            ...
            setMangaToCollection: function(id_manga, user) {
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/add_collection_manga',
                    headers: {
            ...
            removeMangaFromCollection: function(id_manga, user) {
                return $http({
                    method: 'DELETE',
                    url: PATH_PROD+'api/action/delete_collection_manga',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
    ...
    app.factory('tomesService', function($http, $cookies, sAlert) {
        ...
        return {
            getTomesById: function(id) {
                ...
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/tomes/'+id,
                    headers: {
                        'User-ID': userID
                    }
                }).then(function(response) {
            ...
            setTomeToCollection: function(id_manga, id_tome, user) {
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/add_collection_tome',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
            ...
            removeTomeFromCollection: function(id_manga, id_tome, user) {
                return $http({
                    method: 'DELETE',
                    url: PATH_PROD+'api/action/delete_collection_tome',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
    ...
    app.factory('animesService', function($http, $cookies, sAlert) {
        ...
        return {
            getAnimeById: function(id) {
                ...
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/anime/'+id,
                    headers: {
                        'User-ID': userID
                    }
                }).then(function(response) {
            ...
            setAnimeToCollection: function(id_anime, user) {
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/add_collection_anime',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
            ...
            removeAnimeFromCollection: function(id_anime, user) {
                return $http({
                    method: 'DELETE',
                    url: PATH_PROD+'api/action/delete_collection_anime',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
    ...
    app.factory('episodesService', function($http, $cookies, sAlert) {
        ...
        return {
            getEpisodesById: function(id) {
                ...
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/episodes/'+id,
                    headers: {
                        'User-ID': userID
                    }
                }).then(function(response) {
            ...
            setEpisodeToCollection: function(id_anime, id_episode, user) {
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/add_collection_episode',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
            ...
            removeEpisodeFromCollection: function(id_anime, id_episode, user) {
                return $http({
                    method: 'DELETE',
                    url: PATH_PROD+'api/action/delete_collection_episode',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
    ...
    app.factory('searchService', function($http) {
        ...
        return {
            getSearchResult: function(param) {
                return $http.get(PATH_PROD+'api/action/search/'+param).then(function(response) {
    ...
    app.factory('authenticationService', function($http, sAlert, $location, $window) {
        return {
            register: function(username, password, email){
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/register',
            ...
            login : function(username, password){
                return $http({
                    method: 'POST',
                    url: PATH_PROD+'api/action/login',
    ...
    app.factory('userService', function($http) {
        ...
        return {
            getUserById: function(id, token, username) {
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/profil/'+username,
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': token,
    ...
    app.factory('collectionService', function($http) {
        ...
        return {
            getAllCollection: function(id, token) {
                return $http({
                    method: 'GET',
                    url: PATH_PROD+'api/action/collection',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': token,
    ...
    app.factory('usersTomeService', function($http, $cookies) {
        ...
        return {
            getUsersByTome: function (id_manga, number) {
                ...
                return $http({
                    method: 'GET',
                    url: PATH_PROD + 'api/action/users_tome',
                    headers: {
                        'Client-Service': 'frontend-client',
                        'Auth-Key': 'simplerestapi',
                        'Authorization': user.userToken,
